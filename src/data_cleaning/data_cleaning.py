...
def clean_data(df):
    ...
    for col in coffee_choice_cols + tea_choice_cols:
        if col in df.columns:
    ...
    coffee_influencer_cols = [
        'coffee_celebrity', 'coffee_food_blogger', 'coffee_coffee_blogger',
        'coffee_lifestyle_blogger', 'coffee_friends_family',
    ]
    ...
    tea_influencer_cols = [
        'tea_celebrity', 'tea_food_blogger', 'tea_health_blogger',
        'tea_lifestyle_blogger', 'tea_friends_family',
    ]
    ...
    def segment_customer(row):
        ...
        if row.get('like_cafe_amazon') in ['ไม่ชอบ', 'ไม่ชอบดื่ม', 'เฉยๆ'] and row.get('will_try_new_rtd_coffee') in ['ลองแน่นอน', 'อาจจะลอง']:
            return 'New Potential Customers'
        if row.get('like_cafe_amazon') in ['ชอบ', 'ใช่', 'ชอบดื่ม'] and row.get('will_try_new_rtd_coffee') in ['ไม่ลอง', 'ไม่แน่ใจ']:
